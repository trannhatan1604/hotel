...
<div class="container-fluid">
	...
	<form action="<c:url value='/quan-tri/khach-hang/tim-kiem'/>"
				...
				<div class="">
					<div id="dataTable_wrapper"
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-6">
								<div id="dataTable_filter" class="dataTables_filter" style="margin-bottom:10px">
									<!-- 	<form action="#" class="row" style="margin-left: 3px;"> -->
									<div class="row" style="margin-top:10px; margin-bottom:20px">
										<input type="search" name="searchValue"
											class="form-control form-control-sm col-lg-10" 
											placeholder="Tìm kiếm theo tên khách hàng" aria-controls="dataTable">
